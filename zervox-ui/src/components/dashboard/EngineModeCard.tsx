  ...
  return (
    ...
    >
      <div>
        ...
        <div
          className="my-4 rounded-xl p-3.5 text-xs leading-relaxed font-medium bg-slate-100 dark:bg-slate-900/70 border border-slate-300 dark:border-slate-800 text-slate-800 dark:text-slate-200"
        >
          {isAI
        ...
        <div className="grid grid-cols-2 gap-3 pt-1">
          <div className="rounded-xl p-3 bg-slate-100/70 dark:bg-slate-900/60 border border-slate-300 dark:border-slate-800">
            <span className="text-xs font-bold text-slate-800 dark:text-slate-200 block mb-1">OPA Security Gate</span>
          ...
          <div className="rounded-xl p-3 bg-slate-100/70 dark:bg-slate-900/60 border border-slate-300 dark:border-slate-800">
            <span className="text-xs font-bold text-slate-800 dark:text-slate-200 block mb-1">Cluster Executor</span>
            <div className="flex items-center gap-1.5">
          ...
          <div className="rounded-xl p-3 bg-slate-100/70 dark:bg-slate-900/60 border border-slate-300 dark:border-slate-800">
            <span className="text-xs font-bold text-slate-800 dark:text-slate-200 block mb-1">HA Peer Watchdog</span>
            <div className="flex items-center gap-1.5">
          ...
          <div className="rounded-xl p-3 bg-slate-100/70 dark:bg-slate-900/60 border border-slate-300 dark:border-slate-800">
            <span className="text-xs font-bold text-slate-800 dark:text-slate-200 block mb-1">Total Incidents</span>
            <span className="text-sm font-bold font-mono text-teal-800 dark:text-teal-300 block">
